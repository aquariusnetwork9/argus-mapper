 ...
 *
 * <p><b>1.21.11 variant</b> - uses {@code mc.getApiServices().sessionService()} (the
 * {@code ApiServices}-record accessor introduced ~1.21.9/1.21.10) and the new sealed
 * {@code ClickEvent.OpenUrl(URI)} shape. See ARD's client-fabric/README.md's version tables for
 * why 1.21.4 and 1.21.8 each need a different combination of these two.
 */
