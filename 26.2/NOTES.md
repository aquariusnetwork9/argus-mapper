...
Not ported yet: auto-map (`AutoMapper`, the calibration flight, the GUI's Auto-map tab, the map right-click option and `/argus automap`); it is in the 1.21.x builds only for now.
