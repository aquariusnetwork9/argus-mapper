...
/**
 * 26.2's copy of fabric-common's RegionResolver, ported against real Mojang mappings (only real
 * vanilla touchpoint is {@code MinecraftClient} -> {@code Minecraft}, verified via javap). See
 * {@link NetherHighwayFilter}'s own javadoc for why the nether-highway branch below always
 * excludes nether regions rather than doing a real geometry check on this version.
 */
