 ...
 *
 * <p><b>1.21.8 variant</b> - uses {@code mc.getSessionService()} directly (the
 * {@code ApiServices}-record wrapper this became doesn't exist until ~1.21.9/1.21.10) but the
 * new sealed {@code ClickEvent.OpenUrl(URI)} shape (that changed earlier, ~1.21.5). See ARD's
 * client-fabric/README.md's version tables for why 1.21.4 and 1.21.11 each need a different
