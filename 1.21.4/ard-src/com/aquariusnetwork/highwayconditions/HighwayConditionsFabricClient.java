 ...
 *
 * <p><b>1.21.4 fork</b> - the only difference from the current (1.21.8/1.21.11) entrypoint is HUD
 * registration: 1.21.4 predates {@code HudElementRegistry} (introduced at 1.21.6), so this uses
 * {@link HudRenderCallback} instead - see ARD's client-fabric/README.md's HUD-API version table.
 */
public final class HighwayConditionsFabricClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // MC 1.21.4's HUD registration API: HudRenderCallback is the only option here
        // (HudElementRegistry didn't exist until 1.21.6).
